...
<h2><?php _e('Ajuda',self::CLASS_NAME);?>:</h2>


<p>
<?php _e('Para mais detalhes visite a página do plugin',self::CLASS_NAME);?> <a href="<?php echo self::PLUGIN_PAGE?>" target="_blank"><?php echo self::PLUGIN_PAGE?></a>
</p>
<hr />
